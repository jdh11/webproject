  ...
  <div class="main clearfix">
    ...
    <header id="header" class="page-header">
      <!-- <div class="sel sel--black-panther">
      	<select name="select-profession" class="select-choose-sort">
      	...
      	<input type="button" id="button1" onclick="bookSearch();" value="검색">
      </div> -->
      
      <div align="right" class="form-inline">
	  	
		  <input type="text" class="form-control" placeholder="검색어를 입력하세요" id="kwd">
		  <button type="submit" class="btn btn-primary searchBtn" onclick="bookSearch()">Submit</button>
...
function bookSearch(){
	...
	$.ajax({ 
		...
		data : {ttbkey:'ttboptta922158008',Query:searchKeyword,maxresult:'10',Start:'1',Output:'js'}, 
